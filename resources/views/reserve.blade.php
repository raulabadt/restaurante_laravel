...
<div class="px-4 py-12 md:py-24">
    <div class="mx-auto max-w-2xl space-y-8 ">
        ...
        <input type="hidden" id="mesaSeleccionada" name="mesa" value="">
            ...
            <button type="submit" class="flex items-center bg-sky-600 gap-1 px-4 py-2 cursor-pointer text-gray-800 font-semibold tracking-widest rounded-md duration-300 hover:gap-2 hover:translate-x-3">
                Reservar

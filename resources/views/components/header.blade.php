<header class="flex items-center justify-between px-4 py-4 bg-orange-300 flex-wrap">
  <a href="http://vps-c71468c0.vps.ovh.net/restaurante_laravel/public/restaurante_laravel/public/" class="flex items-center">
  ...
  <nav class="flex items-center space-x-4">
    <a class="text-gray-500 hover:text-gray-50 text-base md:text-lg" href="http://vps-c71468c0.vps.ovh.net/restaurante_laravel/resources/views/about">Nosotros</a>

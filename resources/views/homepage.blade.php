...
<body class="bg-gray-100  text-gray-800 ">
    ...
    <section class="relative bg-gray-200 h-96 overflow-hidden">
        <img class="w-full h-full object-cover"  src="{{ asset('images/barra.png') }}?v={{ time() }}" alt="Mi Foto">
        <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white">
            <img class="w-32 h-32 mx-auto mb-4 rounded-full"  src="{{ asset('images//takeaway.jpg') }}?v={{ time() }}" alt="Otra Imagen">

...
<section class="p-8 bg-orange-200 flex flex-col sm:flex-row items-center justify-center">
        <p class="text-lg leading-6 font-medium text-gray-900 mb-4 sm:ml-16">Llama a este número: 673 83 75 97</p>
        <p class="text-lg leading-6 font-medium text-gray-900 mb-4 sm:ml-16">Manda un correo a: info@mirestaurante.com</p>
    </section> -->
...
<section class="py-12 md:py-24 lg:py-32">
  <div class="container flex flex-col items-center justify-center gap-4 px-4 md:px-6">
    <div class="text-center">
      <h2 class="text-3xl font-bold tracking-tighter sm:text-5xl">Contacto</h2>
      <p class="text-3xl  font-medium text-gray-900 mt-8 sm:ml-16">Llama a este número: 673 83 75 97</p>
      <p class="text-3xl  font-medium text-gray-900 mt-8 sm:ml-16">Manda un correo a: info@mirestaurante.com</p>
    </div>
</section>

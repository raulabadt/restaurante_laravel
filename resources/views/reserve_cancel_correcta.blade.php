...
<main class="flex-grow">
    <div class="container mx-auto py-12">
        <div class="max-w-md mx-auto bg-white rounded-lg shadow-md overflow-hidden">
            <div class="p-4">
                <h1 class="text-3xl font-bold text-center mb-4">¡Reserva cancelada correctamente!</h1>
                <p class="text-gray-700 text-center mb-6">Gracias por cancelar su reserva. Su reserva se ha cancelado correctamente.</p>
